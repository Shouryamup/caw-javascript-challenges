...
const createContentDiv = (index) => {
  ...
  const price = createElement("p", "price", "$" + menuItems[index].price / 100);
...
const createSubtotalDiv = (index) => {
  ...
  const subtotal = createElement("div", "subtotal", "$" + subtotalValue);
  return subtotal;
};
...
export { addButtons, buttonTransformToCart, addItemsToCart };
